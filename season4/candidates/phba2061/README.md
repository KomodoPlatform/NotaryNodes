...
#### VOTE Tokens will be airdropped on March 15 2020, if you decide to vote for me, please send your VOTE tokens to the voting address above (you can also obtain the address by scanning the QR image below) before March 31. Thank you for your support !
...
I made a Antara-coin-cap web app, you can visit the app [here](http://antara-coin-cap.herokuapp.com/coinCap). I also made a demo of non-fungible tokens (NFT) marketplace built on Komodo (thanks to Komodo assets/tokens modules), which you find [here](https://github.com/NOCTLJRNE/Komodo-Pokemon/tree/dex) 
